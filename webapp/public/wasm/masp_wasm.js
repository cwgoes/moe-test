 ...
 * @returns {string}
 */
export function derive_asset_type(token_address) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {any}
 */
export function generate_shield_proof(request_js) {
    const ret = wasm.generate_shield_proof(request_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function generate_spend_proof(request_js) {
 ...
 * @returns {any}
 */
export function generate_unshield_proof(request_js) {
    const ret = wasm.generate_unshield_proof(request_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function get_native_asset_type() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {any}
 */
export function load_masp_parameters(spend_params_bytes, output_params_bytes) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('masp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
